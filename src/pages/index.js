...
import profilePic from "../../public/images/profile/developer-pic-1 (Medium).png";
...
export default function Home() {
  return (
    <>
      <Head>
        <title>Sabiha Anum Portfolio</title>
          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full">
              <Image
                src={profilePic}
                alt="Sabiha Anum"
                className="w-7/12 h-auto lg:hidden md:inline-block md:w-full"
                priority={true}
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              />
              <p className="my-4 text-base leading-snug font-medium md:text-sm sm:text-xs">
                As a skilled Web Developer, I am dedicated to turning ideas
                into innovative web applications. Explore my latest projects
                and articles, showcasing my expertise in ReactJs and HTMl.
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="/Resume-Sabiha-Anum.pdf"
                  target={"_blank"}
                ...
                <Link
                  href="mailto:sabihaanum85@gmail.com"
                  target={"_blank"}
